...
version_added: "1.0.0" # of jmcloud.f5 role
author:
...
from ansible.module_utils.jmcloud.network.f5.common import F5_NAMED_OBJ_ARGS
from ansible.module_utils.jmcloud.network.f5.common import F5_PROVIDER_ARGS
from ansible.module_utils.jmcloud.network.f5.bigip import F5BigIpNamedObject
